...
#define BREATH_LED_BRIGHTNESS_NOTIFICATION  "1535"
#define BREATH_LED_BRIGHTNESS_BUTTONS       "747"
#define BREATH_LED_BRIGHTNESS_BATTERY       "0"
#define BREATH_LED_BRIGHTNESS_CHARGING      "747"
...
struct hw_module_t HAL_MODULE_INFO_SYM = {
    ...
    .name = "ZTE,LYF lights Module",
    .author = "Google, Inc., Secret Hero,mainigautam",
